    ...
    body: SingleChildScrollView(
      ...
      child: Container(color: Colors.grey[100],
          child:Column(children: [
            Image.asset("image/OurServices/Rectangle825.png"),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                child: Column(
                  children: [
                    Container(width: width*0.2,
                      child: Image.asset("image/OurServices/Ellipse154.png")),
                      const Padding(
                        padding: EdgeInsets.all(8.0),
                        child: Text("Structural Design",style:TextStyle(fontSize: 20)),
                      )
                  ],
                ),
              ),
              Padding(
                ...
                child: Column(
                  children: [
                    Container(width: width*0.2,
                      child: Image.asset("image/OurServices/Ellipse155.png")),
                      const Padding(
                        padding: EdgeInsets.all(8.0),
                        child: Text("Construction",style:TextStyle(fontSize: 20)),
                      )
                  ],
                ),
              ),
              Padding(
                ...
                child: Column(
                  children: [
                    Container(width: width*0.2,
                      child: Image.asset("image/OurServices/Ellipse156.png",)),
                      const Padding(
                        padding: EdgeInsets.all(8.0),
                        child: Text("Interiors",style:TextStyle(fontSize: 20)),
                      )
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    Container(width: width*0.2,
                      child: Image.asset("image/OurServices/Ellipse157.png")),
                      const Padding(
                        padding: EdgeInsets.all(8.0),
                        child: Text("Utility",style:TextStyle(fontSize: 20)),
                      )
                  ],
                ),
              ),
              Padding(
                ...
                child: Column(
                  children: [
                    Container(width: width*0.2,
                      child: Image.asset("image/OurServices/Ellipse158.png")),
                      const Padding(
                        padding: EdgeInsets.all(8.0),
                        child: Text("Home Automation",style:TextStyle(fontSize: 20)),
                      )
                  ],
                ),
              ),
              Padding(
                ...
                child: Column(
                  children: [
                    Container(width: width*0.2,
                      child: Image.asset("image/OurServices/Ellipse159.png",)),
                      const Padding(
                        padding: EdgeInsets.all(8.0),
                        child: Text("AuthorityApprovals",style:TextStyle(fontSize: 20)),
                      )
                  ],
                ),
              ),
            ...
            Container(width: width*0.8,
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                Container(width: width*0.3,height: height*0.2,color: Colors.grey[200],
                  child: Column(mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Image.asset("image/OurServices/Icons/Vector.png"),
                    ),
                    const Padding(
                      padding: EdgeInsets.all(8.0),
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                ...
                Container(width: width*0.3,height: height*0.2,color: Colors.grey[200],
                  child: Column(mainAxisAlignment: MainAxisAlignment.center,
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Image.asset("image/OurServices/Icons/Vector2.png"),
                    ),
                    const Padding(
                      padding: EdgeInsets.all(8.0),
                ...
                Container(width: width*0.3,height: height*0.2,color: Colors.grey[200],
                  child: Column(mainAxisAlignment: MainAxisAlignment.center,
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Image.asset("image/OurServices/Icons/Vector3.png"),
                    ),
                    const Padding(
                      padding: EdgeInsets.all(8.0),
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                ...
                Container(width: width*0.3,height: height*0.2,color: Colors.grey[200],
                  child: Column(mainAxisAlignment: MainAxisAlignment.center,
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Image.asset("image/OurServices/Icons/Vector4.png"),
                    ),
                    const Padding(
                      padding: EdgeInsets.all(8.0),
                ...
                Container(width: width*0.3,height: height*0.2,color: Colors.grey[200],
                  child: Column(mainAxisAlignment: MainAxisAlignment.center,
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Image.asset("image/OurServices/Icons/Vector5.png"),
                    ),
                    const Padding(
                      padding: EdgeInsets.all(8.0),
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                ...
                Container(width: width*0.3,height: height*0.2,color: Colors.grey[200],
                  child: Column(mainAxisAlignment: MainAxisAlignment.center,
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Image.asset("image/OurServices/Icons/Vector6.png"),
                    ),
                    const Padding(
                      padding: EdgeInsets.all(8.0),
                ...
                Container(width: width*0.3,height: height*0.2,color: Colors.grey[200],
                  child: Column(mainAxisAlignment: MainAxisAlignment.center,
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Image.asset("image/OurServices/Icons/Vector7.png"),
                    ),
                    const Padding(
                      padding: EdgeInsets.all(8.0),
            ...
            Container(width: width*0.8,
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                ...
                Container(width: width*0.3,height: height*0.2,color: Colors.grey[200],
                 ...
                 overflow: TextOverflow.fade ,style: TextStyle(fontSize: 15,color:Colors.black,),),
                ]),),
              ],),
            ),
            SizedBox(height:height*0.05),
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                  ...
                  Container( color: Colors.grey[200],
                    ...
                    color:Color.fromARGB(255, 246, 6, 86) ,),
                      height: 60,width: width*0.2,
                    child: const Align(alignment: Alignment.center, child: Text("Standard Package",style: TextStyle(fontSize: 20,color: Colors.white),)),),
                    ...
                    Padding(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        children: [
                          Row(
                            children: const [Icon(Icons.check,color: Colors.grey,),
                            Text("Adipiscing",style:TextStyle(color: Colors.grey,)),
                            ],),
                          Row(
                        children: const [Icon(Icons.check,color: Colors.grey,),
                        Text("Adipiscing",style:TextStyle(color: Colors.grey,)),
                        ...
                        Row(
                        children: const [Icon(Icons.check,color: Colors.grey,),
                        Text("Adipig",style:TextStyle(color: Colors.grey,)),
                        ],),
                        Row(
                        children: const [Icon(Icons.check,color: Colors.grey,),
                        Text("Adipiscingd",style:TextStyle(color: Colors.grey,)),
                        ],),
                        Row(
                        children: const [Icon(Icons.check,color: Colors.grey,),
                        Text("Dpiscing",style:TextStyle(color: Colors.grey,)),
                        ],),  
                        ],
                      ),
                  ]),),
            ...
            const Padding(
              padding: EdgeInsets.all(8.0),
              child: Text("Got a Concern? We’re Here To Help",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25,color:Colors.black),),
            ),
            Container(width:width*0.8,
              child: const Padding(
                padding: EdgeInsets.all(8.0),
